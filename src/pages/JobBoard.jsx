...
const JobBoard = () => {
  ...
  const getTypeColor = (type) => {
    switch(type) {
      case 'Full-time': return 'bg-blue-800 text-white dark:bg-blue-900/30';
              ...
              <div className="bg-white rounded-2xl shadow-xl p-5">
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1">
                    <div className="flex w-full items-stretch rounded-xl h-12 bg-gray-50 focus-within:ring-2 focus-within:ring-blue-200 transition-all">
